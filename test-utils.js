(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('prop-types'), require('apollo-client'), require('react-dom/server'), require('apollo-link'), require('graphql/language/printer'), require('apollo-cache-inmemory')) :
    typeof define === 'function' && define.amd ? define(['exports', 'react', 'prop-types', 'apollo-client', 'react-dom/server', 'apollo-link', 'graphql/language/printer', 'apollo-cache-inmemory'], factory) :
    (factory((global['react-apollo'] = {}),global.React,global.PropTypes,global.ApolloClient,global.ReactDOM,global.apolloLink,global.printer,global.apolloCacheInmemory));
}(this, (function (exports,React,PropTypes,ApolloClient,ReactDOM,apolloLink,printer,apolloCacheInmemory) { 'use strict';
    ...
    var MockedProvider = (function (_super) {
        ...
        function MockedProvider(props, context) {
            ...
            _this.client = new ApolloClient__default({
                link: link,
                cache: new apolloCacheInmemory.InMemoryCache({ addTypename: false }),
